...
const files = [
  ...
  'assets/i18n/en.js', 'assets/i18n/ar.js', 'api/enquiry.js', 'api/tegiwa-catalog.js', 'api/parts-catalog.js',
  ...
  'scripts/ecs-catalog/build-reviewed-product-shards.mjs', 'scripts/ecs-catalog/bundle-f8x-overlay-release.mjs',
  'scripts/ecs-catalog/publish-reviewed-product-shards.mjs',
