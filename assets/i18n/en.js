  ...
  window.PROJX_TRANSLATIONS.en = {
    ...
    ui: {
      ...
      common: {
        ...
        brand: "Brand",
        sku: "Supplier SKU",
        matchedSku: "Matched supplier SKU",
        selectedSku: "Selected supplier SKU",
        skuOptions: "{count} SKUs — choose option",
        skuTotal: "{count} supplier SKUs in this product",
        skuOpenExact: "Open product for exact SKU",
        skuNotSupplied: "Supplier SKU not supplied",
    ...
    pages: {
      ...
      parts: {
        ...
        finder: {
          overviewEyebrow: "Three ways to shop",
          overviewHeading: "Start with what you already know.",
          overviewText: "Save your vehicle for fitment context, jump straight to a system category, or browse a brand available through Projx Racing.",
          byVehicle: "Shop by Vehicle",
          byCategory: "Shop by Category",
          byBrand: "Shop by Brand",
          vehiclePathText: "Save the car once and carry it into every parts enquiry.",
          categoryPathText: "Go directly to brakes, suspension, cooling and more.",
          brandPathText: "Browse current products and packages by dealer or supported brand.",
          vehicleEyebrow: "Vehicle selection",
          vehicleHeading: "Tell us what you drive.",
          vehicleText: "Your saved vehicle follows every parts enquiry from this page. It helps the workshop check fitment; it does not claim automatic compatibility.",
          year: "Year",
          make: "Make",
          model: "Model",
          engine: "Engine / trim",
          ...
          enginePlaceholder: "e.g. S58",
          saveVehicle: "Save vehicle & browse",
          clearVehicle: "Clear",
          selectedVehicle: "Selected vehicle",
          selectedVehicleText: "Fitment will be confirmed before quotation or order.",
          noVehicle: "No vehicle selected",
          noVehicleText: "You can still browse every category and listed brand.",
          vehicleSaved: "Vehicle saved",
          vehicleCleared: "Saved vehicle cleared",
          categoryEyebrow: "System first",
          categoryHeading: "Shop by category.",
          categoryText: "Choose the area of the car you want to improve. One tap applies the filter and takes you to the current catalogue.",
          brandEyebrow: "Brand first",
          brandHeading: "Shop by brand.",
          brandText: "These brands already appear in the current catalogue. The full directory covers every supplied dealer, reseller and supported platform.",
          viewAllBrands: "View all dealer brands",
          items: "listed",
          resultsEyebrow: "Current catalogue",
          resultsHeading: "Browse the current catalogue.",
          resultsText: "Combine search, category and brand filters. If an exact part is not listed, send its part number for a checked quotation.",
          resultsLabel: "results",
          allBrands: "All listed brands",
          filterByBrand: "Filter by brand",
          sourcingHeading: "One part, one clear recommendation.",
          sourcingText: "When the same product is available from more than one dealer, Projx Racing recommends the best source based on fitment, availability, landed Kuwait price and support.",
          requestUnlisted: "Request an unlisted part",
          compatibility: "Fitment, part number, availability, freight and installation are confirmed by Projx Racing before an order is accepted."
        }
      },
      brands: {
